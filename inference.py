...
# Define paths
WEIGHTS_DIR = r"C:\Users\rthan\OneDrive\Desktop\Person and PPE detection\weights"
PERSON_MODEL_PATH = os.path.join(WEIGHTS_DIR, "best_person.pt")
PPE_MODEL_PATH = os.path.join(WEIGHTS_DIR, "best_ppe.pt")
INPUT_DIR = r"C:\Users\rthan\OneDrive\Desktop\Person and PPE detection\input_directory"
OUTPUT_DIR = r"C:\Users\rthan\OneDrive\Desktop\Person and PPE detection\output_directory"
